$(document).ready(function () {
    ...
    $(document).click(function (e) {
        ...
        if (
            !$(target).is("#accountOption") &&
            !$(target).parents().is(".account-center-opener-wrap")
        ) {
            $("#accountOption").hide();
        }
    });
    ...
    $(".modal-closer, .modal-closer_btn, .modal-closer-btn-na").click(
        function () {
    ...
    */
    ...
    $(".section-nav-tab").click(function () {
        ...
        $(target).addClass("active");
        $(target)
            .siblings(".chart-section, .inner-chart-section")
            .removeClass("active");
    });
    // scrollspy
    $(function () {
    ...
    $(
        ".promo-video .modal-closer, .modal-closer_btn, .modal-closer-btn-na"
    ).click(function () {
        console.log("hit");
...
function navUpdate() {
    $(window).resize(function () {
        if ($(this).width() > 1024) {
            ...
            $(
                "#nav-icon2, .hover-dropdown, .account-center-opener"
            ).removeClass("open");
        }
        if ($(this).width() < 1024) {
    ...
    $(
        ".hover-dropdown, .account-center-opener, .ac-opener-main-btn .nav-item, #notify"
    ...
    $(".ac-opener-main-btn .nav-item").click(function () {
        ...
        $(this)
            .siblings(".account-center-opener-wrap")
            .css({
                position: "fixed",
                top: y + 55,
                right: x - 65,
            });
        $(".hover-dropdown, .account-center-opener, #notify").removeClass(
            "open"
        );
    });
    $("#notify").click(function () {
        $(
            ".hover-dropdown, .account-center-opener, .ac-opener-main-btn .nav-item"
        ).removeClass("open");
